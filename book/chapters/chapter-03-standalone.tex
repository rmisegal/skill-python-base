...
% Standalone compilation wrapper for Chapter 03
% Uses the same preamble structure as main.tex for compatibility
% Compiler: LuaLaTeX
...
%% ============================================
%% Code Listings (must be before tcolorbox listings library)
%% ============================================
\usepackage{listings}
...
%% LTR numbering for all counters (BiDi fix for RTL context)
...
\hypersetup{
  ...
  pdftitle={כלי בינה מלאכותית בעסקים - פרק 3},
...
%% Set chapter counter to 2 so that \chapter produces Chapter 3
